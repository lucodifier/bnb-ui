...
import { PaymentVoucherIcon, ArrowIcon } from "../../../assets/icons/iconsSvg";
  ...
  return (
    <Grid>
      <Paper
        ...
        style={{ backgroundColor: elevation ? "#ffffff" : "#fafafa", ...style }}
        elevation={elevation ? 2 : 0}>
        <div
          className={classes.cardAvatar}
          style={elevation ? { marginLeft: "10px" } : {}}>
          <Avatar
            variant='circular'
            classes={{
              root:
